...
const Film = () => {
  ...
  const similarFilms = allFilms.filter((currentFilm) => currentFilm.genre === film.genre && film.id !== currentFilm.id)
        ...
        <div className="movie-card__wrap">
          <div className="movie-card__desc">
            ...
            <div className="movie-card__buttons">
              ...
              {authorizationStatus ?
                <a href="add-review.html" className="btn movie-card__button" onClick={onAddReviewClickHandler}>
                  Add review
                </a> : ``}
            </div>
          </div>
